        ...
        Confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!Pseudo.getText().toString().matches("") && !Age.getText().toString().matches("")) {
                    ...
                    db.insertPlayer(Pseudo.getText().toString(), Integer.parseInt(Age.getText().toString()), generateUniqueId(Pseudo.getText().toString(), Integer.parseInt(Age.getText().toString())), "0000/00/00 00:00:00");
